        ...
        <div key={project.id} className={`flex flex-col gap-8 lg:gap-16 items-center ${index % 2 !== 0 ? 'lg:flex-row-reverse' : 'lg:flex-row'}`}>
          ...
          <div className="w-full lg:w-3/5">
            <Card className="p-2 overflow-hidden aspect-[4/3] group relative" hover={false}>
              ...
              {/* Note: Using standard img for unsplash placeholder */}
              <img 
                src={project.image} 
                alt={project.title} 
          ...
          <div className={`w-full lg:w-2/5 flex flex-col ${index % 2 !== 0 ? 'lg:items-end lg:text-right' : 'lg:items-start'}`}>
            ...
            <div className="flex items-center gap-4">
              <a href={project.github} target="_blank" rel="noreferrer" className="text-muted hover:text-secondary transition-colors" aria-label="GitHub Link">
                <FaGithub size={24} />
              </a>
              {project.live !== "#" && (
                <a href={project.live} target="_blank" rel="noreferrer" className="text-muted hover:text-secondary transition-colors" aria-label="External Link">
